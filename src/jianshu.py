...
url = 'https://www.jianshu.com//p/051d7a252e2d'
url = 'http://yjsy.blcu.edu.cn/col/col13208/index.html'
url = 'http://app.blcu.edu.cn/yjs_edu/scoreyjs2018fs/index.htm'
html = get_html(url)
print html
